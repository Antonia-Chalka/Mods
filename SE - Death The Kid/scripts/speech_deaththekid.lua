...
return {
	...
	ANNOUNCE_ANTLION_TRIBUTE =
	{
        ...
        "Here. Now leave.",
        "Hopefully that'll keep it occupied for a while...",
	},
	...
	ANNOUNCE_WORMS = "Something's writhing underneath.",
	...
	ANNOUNCE_RESEARCH = "Living beings have come up with so many things...",
	...
	ANNOUNCE_CANFIX = "I might be able to fix this!",
	...
	ANNOUNCE_KLAUS_UNCHAINED = "Even without your chains you'll still fall.",
	...
	DESCRIBE =
	{
		...
		BOOK_SLEEP = "Just skimming its over is making me drowsy.",
        ...
        MIGRATION_PORTAL = 
        {
            GENERIC = "I might be able to step to another world through this..",
		...
		BIRDTRAP = "Not sure why I'd like to trap a bird.",
		CAVE_BANANA_BURNT = "The smell is surprisingly pleasant.",
		BIRD_EGG = "A typical egg. I think.",
		BIRD_EGG_COOKED = "A hearty meal.",
		BISHOP = "I suggest you stay away for your own good.",
		BLOWDART_FIRE = "This seems fundamentally unsafe.",
		BLOWDART_SLEEP = "Wonder if it will work on me.",
		BLOWDART_PIPE = "Black Star would use that as a straw.",
		BLOWDART_YELLOW = "It tingles.",
		BLUEAMULET = "It can keep one cool.",
		BLUEGEM = "It lets off a comforting coldness.",
		BLUEPRINT = 
		{ 
            COMMON = "Unique in its complexity and asymmetry.",
            RARE = "Its asymmetry is even more unbearable!",
        },
        SKETCH = "A picture of a sculpture. Could use some improvements.",
		--BELL_BLUEPRINT = "There's SCIENCE afoot!",
		BLUE_CAP = "The cap of unknown type of mushroom. Mushy and gross.",
		BLUE_CAP_COOKED = "I remember reading something about not eating mysterious mushrooms...",
		BLUE_MUSHROOM =
		{
			GENERIC = "An unknown mushroom.",
			INGROUND = "Seems to have buried itself underground.",
			PICKED = "There's a little bit of it left.",
		},
		BOARDS = "I made sure they were all identical.",
		BONESHARD = "Broken bones.",
		BONESTEW = "...I don't think a human could or should eat this.",
		BUGNET = "In case I want to catch any bugs.",
		BUSHHAT = "It looks ridiculous.",
		BUTTER = "I... am not going to ask where it came from.",
		BUTTERFLY =
		{
			GENERIC = "Hey there.",
			HELD = "It'll be alright.",
		},
		BUTTERFLYMUFFIN = "Somewhat disturbing.",
		BUTTERFLYWINGS = "Poor butterflies.",
		BUZZARD = "I don't like the sounds it makes.",

		SHADOWDIGGER = "Oh good. Now there's more of him.",

		CACTUS = 
		{
			GENERIC = "It's quite nutritious, hence the spikes.",
			PICKED = "It will regrow in time.",
		},
		CACTUS_MEAT_COOKED = "Brings out the fruity flavor.",
		CACTUS_MEAT = "Carefully de-spiked.",
		CACTUS_FLOWER = "A cactus flower.",

		COLDFIRE =
		{
			EMBERS = "It's almost dead.",
			GENERIC = "It provides a temporary protection against... her.",
			HIGH = "I may have added a bit too much fuel.",
			LOW = "It's dying.",
			NORMAL = "A perfectly reasonable level of flame.",
			OUT = "It's gone out, finally.",
		},
		CAMPFIRE =
		{
			EMBERS = "It's almost dead.",
		...
		CANE = "Ugh, this reminds me of Excalibur.",
		CATCOON = "The worst aspects of a cat and a raccoon brought together.",
		CATCOONDEN = 
		{
			GENERIC = "It's a den in a stump.",
			EMPTY = "There aren't any of them left.",
		},
		CATCOONHAT = "I better not be seen wearing this.",
		COONTAIL = "It still moves, like an octopus arm.",
		CARROT = "A perfectly fine vegetable.",
		CARROT_COOKED = "Could use some salt. Or anything else, really.",
		CARROT_PLANTED = "There are more carrots growing.",
		CARROT_SEEDS = "More carrots will come from this.",
		CARTOGRAPHYDESK =
		{
			GENERIC = "We can collect information about this mysterious world.",
			BURNING = "No!",
			BURNT = "Ashes to ashes, dust to dust.",
		},
		WATERMELON_SEEDS = "It's a melon seed.",
		CAVE_FERN = "It's a fern.",
		CHARCOAL = "It reminds me of the fireplace at home.",
        CHESSPIECE_PAWN = "I can relate.",
        CHESSPIECE_ROOK =
        {
            GENERIC = "It's even heavier than it looks.",
            STRUGGLE = "Why is it moving on its own?",
        },
        CHESSPIECE_KNIGHT =
        {
        ...
        CHESSPIECE_MUSE = "I wonder if I can cut off her other arm...",
        CHESSPIECE_FORMAL = "Ominous.",
        CHESSPIECE_HORNUCOPIA = "Very elaborate.",
        CHESSPIECE_PIPE = "This can't be good for your health.",
        CHESSPIECE_DEERCLOPS = "This fees too much like a trophy.",
        CHESSPIECE_BEARGER = "It's anger is immortalized in stone.",
        CHESSPIECE_MOOSEGOOSE = "Sometimes I think it's twitching.",
        CHESSPIECE_DRAGONFLY = "An obvious outcome.",
        CHESSPIECE_CLAYHOUND = "What?",
        CHESSPIECE_CLAYWARG = "What?",
        CHESSJUNK1 = "A horrible pile of broken chess pieces.",
        CHESSJUNK2 = "Another horrible pile of broken chess pieces.",
        CHESSJUNK3 = "Even more horribly broken chess pieces.",
		CHESTER = "It's soul is in that stick.",
		CHESTER_EYEBONE =
		{
			GENERIC = "Hey there.",
			WAITING = "It's body will respawn soon.",
		},
